...
ActiveRecord::Schema.define(version: 2023_06_20_135113) do
  ...
  create_table "budgets", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["money_id"], name: "index_budgets_on_money_id"
    t.index ["payments_balances_id"], name: "index_budgets_on_payments_balances_id"
  ...
  add_foreign_key "budgets", "money"
  add_foreign_key "budgets", "payments_balances", column: "payments_balances_id"
